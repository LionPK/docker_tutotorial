...
<div class="w3-content" style="max-width:2000px;margin-top:46px">
  ...
  <div class="w3-container w3-content w3-center w3-padding-64" style="max-width:2000px" id="Tutorial">
        ...
        <div class="w3-row" style="margin-top:64px">
          <div class="w3-col s3">
            <a href="http://localhost/Docker/index.php/Recommend/recommend" target="_blank"><img src="<?php echo base_url(); ?>assets/images/idea.png" alt="idea" class="w3-hover-opacity"></a>
            <p><br>ทำความรู้จักกับ Docker</p>
          </div>
          <div class="w3-col s3">
            <a href="http://localhost/Docker/index.php/Diction/diction" target="_blank"><img src="<?php echo base_url(); ?>assets/images/diction.png" alt="dictionary" class="w3-hover-opacity"></a>
            <p><br>เรียนรู้คำศัพท์</p>
          </div>

          <div class="w3-col s3">
            <a href="http://localhost/Docker/index.php/Install/install" target="_blank"><img src="<?php echo base_url(); ?>assets/images/gear.png" alt="gear" class="w3-hover-opacity"></a>
            <p><br>การติดตั้งและการตั้งค่า</p>
          </div>

          <div class="w3-col s3">
            <a href="http://localhost/Docker/index.php/Build/build" target="_blank"><img src="<?php echo base_url(); ?>assets/images/use.png" alt="use" class="w3-hover-opacity"></a>
