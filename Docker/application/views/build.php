...
<div class="w3-top">
  <div class="w3-bar" id="myNavbar">
    ...
    <a href="http://localhost/Docker/index.php/DOcker/docker" class="w3-bar-item w3-button w3-hide-small">USE DOCKER</a>
    </a>
  </div>
  ...
  <div id="navDemo" class="w3-bar-block w3-white w3-hide w3-hide-large w3-hide-medium">
    ...
    <a href="http://localhost/Docker/index.php/DOcker/docker" class="w3-bar-item w3-button" onclick="toggleFunction()">USE DOCKER</a>
  </div>
</div>
